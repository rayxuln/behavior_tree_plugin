...
func _ready():
	...
	$HBoxContainer2/ModeOptionButton.clear()
	$HBoxContainer2/ModeOptionButton.add_item("AND")
	$HBoxContainer2/ModeOptionButton.add_item("OR")
	
	if resource_data:
		$HBoxContainer2/ModeOptionButton.selected = resource_data["mode"]
		$HBoxContainer3/FlipCheckBox.pressed = resource_data["flip"]
...
func _on_ModeOptionButton_item_selected(id):
	resource_data["mode"] = id


func _on_FlipCheckBox_toggled(button_pressed):
	resource_data["flip"] = button_pressed
